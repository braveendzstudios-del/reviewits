...
class rvts_form_button_input_hover_border_control {
    ...
    public function register_style_controls( Widget_Base $widget ) {
         ...
         */
        $widget->add_control(
            'rvts_form_button_hover_border_type',
            [
        ...
        $widget->add_responsive_control(
            'rvts_form_button_hover_border_width',
            [
         ...
         */
        $widget->add_control(
            'rvts_form_button_hover_border_color',
            [
